(function(root, factory) {
  ...
  L.TileLayer.KoreaProvider.providers = {
    DaumMap: {
      url: "http://map{s}.daumcdn.net/map_2d/1909dms/L{z}/{y}/{x}.png",
      crs: L.Proj.CRS.Daum,
      options: {
        maxZoom: 13,
        minZoom: 0,
      ...
      variants: {
        ...
        Physical: {
          url:
            "http://map{s}.daumcdn.net/map_shaded_relief/2.00/L{z}/{y}/{x}.png"
        },
        Hybrid: {
    ...
    NaverMap: {
      url:
        "http://onetile{s}.map.naver.net/get/171/0/0/{z}/{x}/{y}/bl_vc_bg/ol_vc_an",
      ...
      variants: {
        ...
        Satellite: {
          url:
            "http://onetile{s}.map.naver.net/get/171/0/1/{z}/{x}/{y}/bl_st_bg"
        },
        Cadastral: {
          url:
            "http://onetile{s}.map.naver.net/get/171/0/0/{z}/{x}/{y}/empty/ol_lp_cn"
        },
        Physical: {
          url:
            "http://onetile{s}.map.naver.net/get/171/0/0/{z}/{x}/{y}/bl_tn_bg/ol_vc_bg/ol_vc_an"
        },
        Hybrid: {
          url:
            "http://onetile{s}.map.naver.net/get/171/0/0/{z}/{x}/{y}/empty/ol_st_rd/ol_st_an"
        },
        Bicycle: {
          url:
            "http://onetile{s}.map.naver.net/get/171/0/0/{z}/{x}/{y}/empty/ol_bc_hb"
        },
        Traffic: {
          url:
            "http://onetile{s}.map.naver.net/get/171/1400247/0/{z}/{x}/{y}/empty/ol_tr_rt/ol_vc_an"
        }
      }
    },
    VWorld: {
      ...
      variants: {
        ...
        Midnight: {
          url:
            "http://xdworld.vworld.kr:8080/2d/midnight/201512/{z}/{x}/{y}.png"
        }
      }
    }
  };
